...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const listingImage = yield page.$eval('img#main-image', el => el.getAttribute('src'), { timeout: 5000 });
    const listingPrice = yield page.$eval('span.apexPriceToPay > span', el => el.innerHTML, { timeout: 5000 });
    browser.close();
}))();
